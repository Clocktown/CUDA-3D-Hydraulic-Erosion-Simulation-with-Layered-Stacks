...
static_assert(sizeof(long long int) == 8, "Long long int must have a size of 8 bytes");
    ...
    static_assert(false, "ONEC_DEBUG and ONEC_RELEASE cannot be defined at the same time");
#endif
...
#ifdef ONEC_DEBUG
#   define ONEC_ERROR(message) std::cerr << "ONEC Error: " << message << "\n"\
                                         << "File: " << __FILE__ << "\n"\
                                         << "Line: " << __LINE__ << "\n";\
...
#   define ONEC_ASSERT(condition, message) if (!(condition))\
                                           ...
                                           static_cast<void>(0)
#   define ONEC_IF_DEBUG(function) function
#   define ONEC_IF_RELEASE(function) static_cast<void>(0)
#endif

#ifdef ONEC_RELEASE
#   define ONEC_ERROR(message) static_cast<void>(0)
#   define ONEC_ASSERT(condition, message) static_cast<void>(0)
#   define ONEC_IF_DEBUG(function) static_cast<void>(0)
#   define ONEC_IF_RELEASE(function) function
#endif
