...
inline void updateTrackballs(const entt::exclude_t<Excludes...> excludes)
{
	...
	const auto view{ world.getView<Position, Rotation, Trackball>(excludes) };
	...
	for (const entt::entity entity : view)
	{
		...
		Transform transform{ view.get<Position>(entity).position, view.get<Rotation>(entity).rotation };
