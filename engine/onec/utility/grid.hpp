...
CU_HOST_DEVICE CU_IF_HOST(constexpr) glm::ivec2 wrapIndex(glm::ivec2 index, glm::ivec2 size);
CU_HOST_DEVICE CU_IF_HOST(constexpr) glm::ivec3 wrapIndex(glm::ivec3 index, glm::ivec3 size);
